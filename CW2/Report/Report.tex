...
\begin{table}[bp]
  ...
  \hline
  \multicolumn{1}{|c|}{Task and Weighting} & \multicolumn{1}{c|}{Data preprocessing (10\%)} & \multicolumn{1}{c|}{Feature Selection (25\%)} & \multicolumn{1}{c|}{ML method development (25\%)} & Method Evaluation (10\%) & \multicolumn{1}{c|}{Report Writing (30\%)} \\ \hline
